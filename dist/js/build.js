...
define("tools/require.js", function(){});
...
(function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		define('tools/jquery.ui.widget',[ "jquery" ], factory );
	} else {
...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define('tools/jquery.fileupload',[
            'jquery',
            'tools/jquery.ui.widget'
        ], factory);
    } else {
        // Browser globals:
...
define('settingsPanel',['tools/jquery-1.11.1.min'], function() {
  settingPanel();
});
